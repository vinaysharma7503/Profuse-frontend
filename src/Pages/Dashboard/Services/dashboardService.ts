...
const {USERSLIST,SIGNUP,USERDASHBOARD,CHANGEUSERSTATUS,DELETEUSER,CATEGORYLIST,CREATECATEGORY,CREATEPRODUCT,PRODUCTLIST,DELETEPRODUCT,INVESTAMOUNT,TRANSACTIONSLIST} = apiEndPoints;
